...
image_s = pygame.image.load(os.path.join("Assets/Other", "food.png"))
image_s = pygame.transform.scale(image_s, (100, 80))
foods = [image_s]
...
def main():
    ...
    while run:
        ...
        ethiopian_stripe_height = SCREEN_HEIGHT1 // 10
        pygame.draw.rect(SCREEN, GREEN, (SCREEN_WIDTH1 // 2 - 120, 0, 140, ethiopian_stripe_height))
        pygame.draw.rect(SCREEN, YELLOW, (SCREEN_WIDTH1 // 2 - 120, ethiopian_stripe_height, 140, ethiopian_stripe_height))
        pygame.draw.rect(SCREEN, RED, (SCREEN_WIDTH1 // 2 - 120, ethiopian_stripe_height * 2, 140, ethiopian_stripe_height))

        italian_stripe_height = SCREEN_HEIGHT1 *3// 10
        pygame.draw.rect(SCREEN, GREEN, (SCREEN_WIDTH1 // 2 + 80, 0, 45, italian_stripe_height))
        pygame.draw.rect(SCREEN, WHITE, (SCREEN_WIDTH1 // 2 + 80 + 45, 0, 45, italian_stripe_height))
        pygame.draw.rect(SCREEN, RED, (SCREEN_WIDTH1 // 2 + 80 + 90, 0, 45, italian_stripe_height))
        ...
        if len(obstacles) == 0:
            if random.randint(0, 3) <= 1:
                obstacles.append(Fire(largeObstacle))
